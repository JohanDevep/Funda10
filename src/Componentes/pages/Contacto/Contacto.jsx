    ...
    <contacto className="contacto">
      ...
      <div className="general-contacto">
        <div className="escribanos-contacto">
          ...
          <div className="texto-mensaje-ahora">Escribanos ahora un mensaje</div>
        ...
        <div className="visitanos-llamanos">
          <div className="Cuadro-textos">
            ...
            <div className="texto-interno-general">+573186929471</div>
          </div>
          <div className="Cuadro-textos">
            <div className="general-textos">
              <div className="texto-general-titulos">Visítanos</div>
              <img
            ...
            <p className="texto-interno-general">AV 26 # 26 A - 05 B/Las Granjas</p>
          </div>
      ...
      <div className="iframe">
          <iframe className="iframe-ubi" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d249.03477277653073!2d-75.29097036930523!3d2.942946825116622!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses-419!2sco!4v1693348170790!5m2!1ses-419!2sco"></iframe>
        </div>
    </contacto>
